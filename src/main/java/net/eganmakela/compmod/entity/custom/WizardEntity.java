package net.eganmakela.compmod.entity.custom;
...
public class WizardEntity extends Animal  {
    public WizardEntity(EntityType<? extends Animal> pEntityType, Level pLevel)
    {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new GolemRandomStrollInVillageGoal(this, 1));
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.WIZARD.get().create(pLevel);
    }
